    ...
    <Container>
      <div className="wrapper">
        <Heatmap
          startDate={startDate}
          endDate={endDate}
          values={generateHeatMap(startDate, endDate)}
          gutterSize={3.5}
      ...
      <span>Random Calender (do not represent actual data)</span>
    </Container>
  );
};

const generateHeatMap = (startDate: Date, endDate: Date) => {
